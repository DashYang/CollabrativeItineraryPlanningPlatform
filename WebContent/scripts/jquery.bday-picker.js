...
(function( $ ){
    ...
    $.fn.birthdaypicker = function( options ) {
        ...
        var settings = {
            "maxAge" : 120,//设置“年”下拉表中“年”的个数
            "minAge" : 0,//最小年龄
            "futureDates" : false,// 将来（未来）时间是否可以选择
            "maxYear" : todayYear,//年列表中最大年，你可用一个具体年如，'2013-07-06'或者采用变量获取当前年的字符串。
            "dateFormat" : "middleEndian",//在这里format指的是显示年月日的顺序
            "monthFormat" : "short",
            "placeholder" : true,//是否显示默认提示的信息。
            "defaultDate" : false,//元素初始时的值
            "fieldName" : "birthdate",//隐藏域元素的name值 默认为：birthdate
            "fieldId" : "birthdate",//隐藏域元素的id值 默认为：birthdate
            "hiddenDate" : true,//是否要添加一个时间隐藏域，值为true或false 默认为true
            "onChange" : null,
            "tabindex" : null,
            "wraper" : "fieldset",//为盛放select元素的容器，这个是我自己扩展的，原来插件只支持fieldset，修改后可以有多种方式选择
            "legend" : "",
        };
